...
def start_balloons_fall(balloons_rect, list_of_balloons):
...
def fire(bullet_image, bullet_rect, bullet_status, character_position, is_ready_to_fire):
  ...
  return bullet_status, bullet_rect, is_ready_to_fire
...
def update_highest_score():
  score = open('highest_score.txt', 'w')
  pass
...
def draw_window(CHARACTER, start_button_clicked, key_pressed, IMAGE_POSITION, last_direction, character_score, collision_occurred, run, balloons_rect, list_of_balloons, is_game_over, random_number_pos_x, bullet_status, bullet_rect, character_position, is_ready_to_fire):
  if is_video_ended() and not start_button_clicked:
    ...
    text_draw("Highest Score : " + str(0), SCORE_FONT, SCORE_COLOR_RED, 20, 50)
    start_balloons_fall(balloons_rect, list_of_balloons)
    bullet_status, bullet_rect, is_ready_to_fire = fire(bullet_image, bullet_rect, bullet_status, character_position, is_ready_to_fire)
  ...
  return IMAGE_POSITION, last_direction, character_score, collision_occurred, run, is_game_over, random_number_pos_x, bullet_status, CHARACTER, bullet_rect, is_ready_to_fire
...
def main():
  ...
  while run:
    ...
    is_video_ended()
    IMAGE_POSITION, last_direction, character_score, collision_occurred, run, is_game_over, random_number_pos_x, bullet_status, CHARACTER, bullet_rect, is_ready_to_fire = draw_window(CHARACTER, start_button_clicked, key_pressed, IMAGE_POSITION, last_direction, character_score, collision_occurred, run, balloons_rect, list_of_balloons, is_game_over, random_number_pos_x, bullet_status, bullet_rect, character_position, is_ready_to_fire)
